      ...
      <div className="main-area">
        ...
        <header className="topbar">
          <div className="search-bar">
            <Search size={18} />
            <input type="text" placeholder="Search students, skills, drives..." />
          </div>
        ...
        <main className="content-wrapper">
          <div style={{ marginBottom: '2rem' }}>
            <h1 className="section-title">Institute Placement Command</h1>
                  ...
                  <tbody>
                    <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                      <td style={{ padding: '1rem 0', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        ...
                        <div>
                          <strong style={{ display: 'block', fontSize: '0.9rem' }}>TechVantage AI</strong>
                          <span style={{ fontSize: '0.7rem', color: '#64748b' }}>Tier-1 Partner</span>
                        </div>
                      </td>
                      <td style={{ fontSize: '0.9rem' }}>Software Eng.</td>
                      <td style={{ padding: '1rem 0' }}>
                        <div style={{ width: '50px', background: '#e2e8f0', borderRadius: '12px', padding: '0.2rem', fontSize: '0.7rem', textAlign: 'center' }}>+142</div>
                      </td>
                      <td style={{ fontSize: '0.85rem', color: '#d15112', fontWeight: '500' }}>2 Days Left</td>
                      <td><span className="badge badge-teal">Interviewing</span></td>
                    </tr>
                    <tr>
                      <td style={{ padding: '1rem 0', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        <div style={{ width: '32px', height: '32px', background: '#f1f5f9', borderRadius: '6px', flexShrink: 0 }} className="flex-center"><Building2 size={16}/></div>
                        <div>
                          <strong style={{ display: 'block', fontSize: '0.9rem' }}>Skyline Cloud</strong>
                          <span style={{ fontSize: '0.7rem', color: '#64748b' }}>New Entry</span>
                        </div>
                      </td>
                      <td style={{ fontSize: '0.9rem' }}>Cloud Arch.</td>
                      <td style={{ padding: '1rem 0' }}>
                         <div style={{ width: '50px', background: '#e2e8f0', borderRadius: '12px', padding: '0.2rem', fontSize: '0.7rem', textAlign: 'center' }}>+56</div>
                      </td>
                      <td style={{ fontSize: '0.85rem' }}>Oct 24, 2026</td>
                      <td><span className="badge badge-gray">Registration</span></td>
                    </tr>
                  </tbody>
               </table>
            </div>
