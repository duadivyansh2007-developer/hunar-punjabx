      ...
      <div className="main-area">
        ...
        <header className="topbar">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
            <Bell size={20} color="#64748b" onClick={() => setToast({ visible: true, message: '0 new notifications.' })} style={{ cursor: 'pointer' }}/>
            <HelpCircle size={20} color="#64748b" onClick={() => setToast({ visible: true, message: 'Help center is active.' })} style={{ cursor: 'pointer' }}/>
            <button className="btn btn-primary" style={{ gap: '0.5rem', borderRadius: '20px' }} onClick={() => setIsChatOpen(true)}>
              <Bot size={18}/> AI Chatbot
            </button>
            <div style={{ background: '#e2e8f0', borderRadius: '50%', padding: '0.5rem', cursor: 'pointer' }} title={userName} onClick={() => setToast({ visible: true, message: 'Profile editing coming soon.' })}><User size={20} color="#00283e"/></div>
          </div>
        </header>
        ...
        <main className="content-wrapper">
          {activeSection === 'Overview' ? (
              ...
              <div className="grid-3" style={{ gridTemplateColumns: '1fr 2fr', marginBottom: '2rem' }}>
                ...
                <div className="card">
                  <div className="flex-between" style={{ marginBottom: '1.5rem' }}>
                    ...
                    <span style={{ color: '#0ea5e9', fontSize: '0.9rem', fontWeight: '500', cursor: 'pointer' }} onClick={() => setActiveSection('Readiness')}>View Full Roadmap →</span>
                  </div>
                    ...
                    {filteredJobs.length > 0 ? filteredJobs.map(job => (
                      <div key={job._id} className="flex-between">
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                          ...
                          <div style={{ background: '#f1f5f9', padding: '0.5rem', borderRadius: '6px', cursor: 'pointer' }} onClick={() => setToast({ visible: true, message: `Application sent to ${job.companyId?.name || 'Company'}!` })}><ChevronRight size={16}/></div>
                        </div>
                      </div>
            ...
            <div className="card flex-center" style={{ height: '400px', flexDirection: 'column', gap: '1rem' }}>
               ...
               <p style={{ color: '#64748b' }}>The AI is analyzing district-level data for this section.</p>
